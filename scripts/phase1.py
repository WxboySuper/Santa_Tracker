...
def generate_anchor_list():
    ...
    country_data_map = {} # This will store { 'US': { capital: '...', timezones: '...' }, ... }
    capital_search_list = []
    ...
    try:
        ...
        for city_name, country_code in anchor_search_list:
            ...
            if city_result:
                ...
                print(f"  > Warning: Could not find '{city_name}, {country_code}' in cities.sqlite3.")
    ...
    print(f"Step 3: Saving {len(final_anchor_list)} complete anchors to {OUTPUT_FILE}...")
    try:

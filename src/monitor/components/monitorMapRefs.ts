...
export const useMonitorMapRefs = () => ({
  ...
  ndfdTemperatureLayerRef: useRef<TileLayer<TileWMS> | null>(null),
  mesoscaleDiscussionLayerRef: useRef<VectorLayer<VectorSource> | null>(null),
  ...
  ndfdTemperatureLayerKeyRef: useRef<string | null>(null),
  ...
  mesoscaleDiscussionSourceRef: useRef(new VectorSource()),

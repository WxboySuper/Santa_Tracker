...
def get_santa_locations():
    ...
    return [
        Location(
            ...
            country="Arctic",
            priority=1,
            notes="Santa's workshop and home! This is where all the magic begins.",
            # Deprecated fields for backward compatibility
            stop_duration=585,
            is_stop=True,
        ),
        Location(
            ...
            priority=1,
            notes="The city that never sleeps - perfect for Santa's midnight deliveries!",
            # Deprecated fields for backward compatibility
            stop_duration=15,
            is_stop=True,
        ),
        Location(
            ...
            priority=2,
            notes="Home of Big Ben and the Royal Family!",
            # Deprecated fields for backward compatibility
            stop_duration=20,
            is_stop=True,
        ),
        Location(
            ...
            country="Japan",
            priority=2,
            notes="Famous for its mix of traditional temples and modern skyscrapers!",
            # Deprecated fields for backward compatibility
            stop_duration=25,
            is_stop=True,
        ),

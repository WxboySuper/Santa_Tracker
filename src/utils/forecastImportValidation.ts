...
const validateTreeBounds = (
  ...
  if (typeof value === 'string') {
    if (value.length > MAX_STRING_LENGTH) {
      return fail('Forecast file contains an excessively long string.');
    }
    return null;
  }

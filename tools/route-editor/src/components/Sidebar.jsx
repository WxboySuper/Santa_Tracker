        ...
        {isExpanded && (
          <div className="mt-3 pt-3 border-t border-gray-200 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">UTC Offset</label>
                <input
                  type="number"
                  value={location.utc_offset}
                  onChange={(e) => handleChange('utc_offset', parseInt(e.target.value) || 0)}
                  min="-12"
                  max="14"
                  className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  onClick={(e) => e.stopPropagation()}
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Stop Duration (minutes)</label>
              <input
                type="number"
                value={location.stop_duration || 0}
                onChange={(e) => handleChange('stop_duration', parseInt(e.target.value) || 0)}
                min="0"
                className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                onClick={(e) => e.stopPropagation()}
              />
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Population (optional)</label>
              <input
                type="number"
